...
print("SECTION 12 — SOUNDSCAPE DENSITY")

# Load the soundscape labels CSV
sc_labels = _load_csv(TRAIN_SOUNDSCAPES_LABELS_CSV)

# Count occurrences of each filename in the soundscape labels
filename_counts = Counter(label['filename'] for label in sc_labels)

# Get the top 10 most common filenames
top_10_filenames = filename_counts.most_common(10)

# Print the top 10 most common filenames and their counts
for filename, count in top_10_filenames:
